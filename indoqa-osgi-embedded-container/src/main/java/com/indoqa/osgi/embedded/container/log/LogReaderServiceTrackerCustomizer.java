 ...
 */
package com.indoqa.osgi.embedded.container.log;
...
public class LogReaderServiceTrackerCustomizer implements ServiceTrackerCustomizer<LogReaderService, LogReaderService> {
    ...
    @Override
    public void modifiedService(ServiceReference<LogReaderService> serviceReference, LogReaderService logReader) {

    }

    @Override
    public void removedService(ServiceReference<LogReaderService> serviceReference, LogReaderService logReader) {
    }
}
